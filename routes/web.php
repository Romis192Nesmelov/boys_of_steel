...
//Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/leadership', [OurSupportController::class, 'leadership'])->name('leadership');
    Route::get('/our_support', [OurSupportController::class, 'ourSupport'])->name('our_support');
