<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        @include('partials.head1',['head' => 'Итоги 2го открытого чемпионата по хоккею с шайбой<br>на Кубок «Парни из Стали», г.Самара'])

        @foreach($games as $game)
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="w-full flex flex-col md:flex-row items-center justify-start mb-4">
                    <a href="{{ gameImage($game) }}" class="w-80 mr-0 mb-4 md:mr-5 md:mb-0 fancybox">
                        <img class="border-2 border-solid" src="{{ gameImage($game) }}" />
                    </a>
                    <div class="w-full">
                        <div class="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between mb-4">
