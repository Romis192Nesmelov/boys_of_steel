    ...
    <div class="max-w-7xl mx-auto pt-6">
        ...
        <div class="flex flex-col md:flex-row items-center justify-start pt-6">
            ...
            <div class="px-4 md:px-0 md:col-span-2">
                ...
                <p class="text-gray-300 text-xl mb-6">Проект направлен на создание спортивного братства, вовлечение ветеранов боевых действий и членов их семей в коллективные спортивные соревнования, адаптацию и социализацию ветеранов в кругу общих интересов через физкультуру и спорт.</p>
                <p class="text-gray-300 text-xl mb-6">Проведение хоккейного турнира с участием 8 команд ветеранов из Самары, Омска, Санкт-Петербурга, Уфы, Нижнего Новгорода, Екатеринбурга, Челябинска и Москвы ставит перед собой решение следующих важных задач:</p>
                <ul class="text-gray-300 list-disc text-xl ps-10">
